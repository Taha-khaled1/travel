		...
		<div class="main-header-right">
			...
			<div class="nav nav-item  navbar-nav-right ml-auto">
				...
				{{-- <div class="main-img-user profile-user">
					<img alt="" src="{{URL::asset('logoweb.png')}}"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);"></a>
				</div> --}}
				...
				<div class="dropdown main-profile-menu nav nav-item nav-link">
					<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('logoweb.png')}}"></a>
					<div class="dropdown-menu">
						<div class="main-header-profile bg-primary p-3">
							<div class="d-flex wd-100p">
								<div class="main-img-user"><img alt="" src="{{URL::asset('logoweb.png')}}" class=""></div>
