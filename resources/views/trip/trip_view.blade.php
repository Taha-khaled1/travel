...
@section('content')
    ...
    <div class="row">
                        ...
                        <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50'>
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">نوع الحدث</th>
                                    <th class="border-bottom-0">الدوله</th>
                                    <th class="border-bottom-0">المدينه</th>
                                 
                                    <th class="border-bottom-0">السعر</th>
                                    <th class="border-bottom-0">حالة الرحله</th>
        ...
        <!-- edit -->
        {{-- <div class="modal fade" id="edit_trip" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="modal fade" id="modaldemo9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ URL::route('trip.destroy') }}" method="post">
                        {{ method_field('post') }}
                        {{ csrf_field() }}
                        <div class="modal-body">
...
@section('js')
    ...
    <script>
        $('#edit_trip').on('show.bs.modal', function(event) {
