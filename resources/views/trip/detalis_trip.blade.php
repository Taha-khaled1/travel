    ...
    <div class="rlr-overview-detail__icons">
      <figure class="rlr-icon-text"><i class="rlr-icon-font flaticon-map-marker"> </i> <span class=""> {{$trip->trip_details->price_day}}</span></figure>
        ...
        <aside class="col-xl-4 col-xxxl-3 d-xl-block offset-xxxl-1 mt-5 mt-lg-0">
          <form class="rlr-booking-card" action="{{route('check_out')}}">
            <fieldset class="rlr-fieldrow">
              ...
              <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                <label class="rlr-form-label rlr-form-label--dark rlr-booking-card__label" for="rlr-booking-dateranges-input"> متي تريد ان تكون بداية الحجز </label>
                <div class="rlr-input-group rlr-input-group__datefield rlr-js-booking-form-daterange" id="rlr-booking-startRange">
                  <input type="date" name="start_data" id="rlr-booking-dateranges-input" class="form-control form-input text-end p-0 pe-3" placeholder="اضغط لاختيار الوقت المناسب" />
                </div>
              </div>
              
              <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                <label class="rlr-form-label rlr-form-label--dark rlr-booking-card__label" for="rlr-booking-dateranges-input"> متي تريد ان تكون نهاية الحجز </label>
                <div class="rlr-input-group rlr-input-group__datefield rlr-js-booking-form-daterange" id="rlr-booking-startRange">
                  <input type="date" name="end_data" autocomplete="off" id="rlr-booking-dateranges-input" class="form-control form-input text-end p-0 pe-3" placeholder="اضغط لاختيار الوقت المناسب" />
                </div>
              </div>
              <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                <label class="rlr-form-label rlr-form-label--dark rlr-booking-card__label" for="rlr-booking-selection-input">هل تريد اخذ مميزات معينه</label>
            ...
            <a class="btn rlr-button rlr-booking-card__button" id="submit-form-btn">اكمال عملية الحجز</a>
          </form>
...
<script>
  ...
  const form = document.querySelector('.rlr-booking-card');
