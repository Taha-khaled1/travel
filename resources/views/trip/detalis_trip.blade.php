    ...
    <div class="container">
        ...
        <div class="rlr-product-detail-section__details col-xl-8">
            ...
            <div class="rlr-product-detail-header__contents">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb rlr-breadcrumb__items">
                  <li class="breadcrumb-item rlr-breadcrumb__item"><a href="/">الصفحه الرئيسيه</a></li>
                  <li class="breadcrumb-item rlr-breadcrumb__item"><a href="/">الحدث</a></li>
                  <li class="breadcrumb-item rlr-breadcrumb__item active" aria-current="page">تفاصيل الحدث</li>
                </ol>
              </nav>
          ...
          <nav class="rlr-product-detail-secondary-menu">
            <ul class="rlr-product-detail-secondary-menu__tabitems" id="rlr-js-secondary-menu">
              <li class="rlr-product-detail-secondary-menu__tabitem js-tabitem is-active" id="rlr-product-sec-overview"><span>ملخص</span></li>
              <li class="rlr-product-detail-secondary-menu__tabitem js-tabitem" id="rlr-product-sec-inclusion"><span>المميزات</span></li>
              <li class="rlr-product-detail-secondary-menu__tabitem js-tabitem" id="rlr-product-sec-review"><span>المراجعه</span></li>
              <li class="rlr-product-detail-secondary-menu__tabitem js-tabitem" id="rlr-product-sec-faq"><span>اسئله عن الرحله</span></li>
              <li class="rlr-product-detail-secondary-menu__tabitem js-tabitem" id="rlr-product-sec-info"><span>تفاصيل</span></li>
            </ul>
          </nav>
          <!-- Overview -->
          ...
          <form class="rlr-booking-card">
            <fieldset class="rlr-fieldrow">
              ...
              <article itemscope itemtype="https://schema.org/Offer" class="rlr-booking-card__price-details rlr-fieldrow__form-element">
                ...
                <span class="rlr-booking-card__info">السعر على أساس التحديدات أدناه</span>
              </article>
              <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                <label class="rlr-form-label rlr-form-label--dark rlr-booking-card__label" for="rlr-booking-dateranges-input"> متي تريد ان تكون بداية الرحله </label>
                <div class="rlr-input-group rlr-input-group__datefield rlr-js-booking-form-daterange" id="rlr-booking-startRange">
                  <input type="text" autocomplete="off" id="rlr-booking-dateranges-input" class="form-control form-input text-end p-0 pe-3" placeholder="اضغط لاختيار الوقت المناسب" />
                </div>
              </div>
              <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                <label class="rlr-form-label rlr-form-label--dark rlr-booking-card__label" for="rlr-booking-dateranges-input"> متي تريد ان تكون نهاية الرحله  </label>
                <div class="rlr-input-group rlr-input-group__datefield rlr-js-booking-form-daterange" id="rlr-booking-startRange">
                  <input type="text" autocomplete="off" id="rlr-booking-dateranges-input" class="form-control form-input text-end p-0 pe-3" placeholder="اضغط لاختيار الوقت المناسب" />
                </div>
              </div>
              <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                <label class="rlr-form-label rlr-form-label--dark rlr-booking-card__label" for="rlr-booking-selection-input"> هل تريد اخذ مميزات معينه في الرحله </label>
                <div class="rlr-input-group" data-bs-toggle="popover-booking" data-content-id="rlr-js-booking-selection" id="rlr-js-booking-selection-button">
                  <input type="text" id="rlr-booking-selection-input" autocomplete="off" class="form-control form-input text-end p-0 pe-3 rlr-popover-button" placeholder="اضغط للتحديد" />
                ...
                <div id="rlr-js-booking-selection" class="rlr-popover--hide">
                  <div id="rlr-js-booking-selection-bookingform" data-name="booking-form">
                    <div class="rlr-popover__header">
                      <label class="rlr-form-label rlr-form-label--light"> اختار </label>
                      ...
                      <ul class="rlr-checkboxes">
                        <li class="form-check form-check-block rlr-popover__checkbox-wrapper">
                          <div class="rlr-popover__checkbox">
                            <input class="form-check-input rlr-form-check-input" id="rlr-booking-single-room" type="checkbox" value="Single Room" /> <label class="rlr-form-label rlr-form-label--checkbox" for="rlr-booking-single-room"> غرفة مفردة </label>
                          </div>
                          <span class="rlr-popover__price">AED يحدد عند التواصل</span>
                        </li>
                        <li class="form-check form-check-block rlr-popover__checkbox-wrapper">
                          <div class="rlr-popover__checkbox">
                            <input class="form-check-input rlr-form-check-input" id="rlr-booking-deluxe-room" type="checkbox" value="Deluxe Room" /> <label class="rlr-form-label rlr-form-label--checkbox" for="rlr-booking-deluxe-room"> غرفة ديلوكس </label>
                          </div>
                          <span class="rlr-popover__price">AED يحدد عند التواصل</span>
                        </li>
                     
                        <li class="form-check form-check-block rlr-popover__checkbox-wrapper">
                          <div class="rlr-popover__checkbox"><input class="form-check-input rlr-form-check-input" id="rlr-breakfast" type="checkbox" value="Breakfast" /> <label class="rlr-form-label rlr-form-label--checkbox" for="rlr-breakfast"> إفطار </label></div>
                          <span class="rlr-popover__price">AED يحدد عند التواصل</span>
                        </li>
                      </ul>
                    </div>
            ...
            <fieldset class="rlr-booking-card__results rlr-booking-card__results--found">
              <ul class="rlr-booking-card__result-list">
                <li class="rlr-icon-text">
                  ...
                  <div class="rlr-icon-text__text-wrapper">
                    <span class="">{{$trip->trip_details->start_time}} </span>
                    <span class="rlr-icon-text__subtext">وقت البدء</span>
                  </div>
                </li>
              </ul>
              <div class="rlr-icon-text rlr-booking-card__message">
                ...
                <div class="rlr-icon-text__text-wrapper">
                  <span class="">تأكيد فوري  </span>
                  <span class="rlr-icon-text__subtext">بمجرد تأكيد الحجز ، ستتلقى تفاصيل للطباعة.</span>
                </div>
              </div>
            </fieldset>
      ...
      <section class="rlr-section rlr-section__mt rlr-related-product-wrapper">
        ...
        <div class="row rlr-featured__cards">
         ...
         @foreach ($smillerProduct as $item)
         <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-offset="250" data-aos-duration="700">
          ...
          <article class="rlr-product-card rlr-product-card--featured" itemscope itemtype="https://schema.org/Product">
            ...
            <figure class="rlr-product-card__image-wrapper">
              <img itemprop="image" data-src="{{URL::asset($item->image)}}" data-srcset="{{URL::asset($item->image)}}" data-sizes="auto" class="lazyload" alt="" style="width: 100%;  border: 1px solid #ccc; height: 335px; border-radius: 20;"/>
            </figure>
            <!-- Card body -->
            <div class="rlr-product-card--featured__inner">
              ...
              <div class="rlr-product-card--featured__body card-img-overlay">
                <div class="rlr-product-card--featured__duration">
                  ...
                  <h4 class="type-h4">AED {{$item->price}}</h4>
                </div>
                <div class="rlr-product-detail-header__actions">
                  <div class="rlr-product-detail-header__button-wrapper">
                  ...
                  <a href="{{ route('detalis.Trip',$item->id) }}" class="btn rlr-button product-card-buttonrlr-button--medium rlr-button--rounded rlr-button--brand"> اكتشف </a>
                </div>
              </div>
            </div>
            <a href="{{ route('detalis.Trip',$item->id) }}" class="rlr-product-card__anchor rlr-product-card__anchor--featured"></a>
          </article>
          <!-- Summary -->
          <div class="rlr-product-card--featured__summary">
            <h4 class="type-h6-semi-bold">{{$item->name}}</h4>
            <p class="type-body">تحقق من العروض اليومية والعروض الترويجية على الفنادق. حجز سهل وسريع</p>
          </div>
        </div>
        ...
        <div class="rlr-product-detail-section__details col-xl-8">
          ...
          <div class="rlr-product-detail-header" id="rlr-js-detail-header">
            <div class="rlr-product-detail-header__contents">
              ...
              <h1 class="rlr-section__heading--main rlr-product-detail-header__title">London to Ancient Rome Short Weekend Tour</h1>
              <div class="rlr-review-stars" itemscope itemtype="https://schema.org/Product">
                <div class="rlr-review-stars" itemprop="ratingValue" itemscope itemtype="https://schema.org/Product">
                  <i class="rlr-icon-font flaticon-star-1"> </i> <i class="rlr-icon-font flaticon-star-1"> </i> <i class="rlr-icon-font flaticon-star-1"> </i> <i class="rlr-icon-font flaticon-star-1"> </i> <i class="rlr-icon-font flaticon-star"> </i>
                </div>
              ...
              <div class="accordion rlr-accordion">
                <div class="accordion-item rlr-accordion__item">
                  <div class="accordion-header rlr-accordion__header" id="rlr-itinerary-header1">
                    <button class="accordion-button rlr-accordion__button" type="button" data-bs-toggle="collapse" data-bs-target="#rlr-itinerary-collapse1" aria-expanded="true" aria-controls="rlr-itinerary-collapse1"><span class="rlr-accordion__badge">1</span> Day 1</button>
                  </div>
                  <div id="rlr-itinerary-collapse1" class="accordion-collapse collapse show" aria-labelledby="rlr-itinerary-header1">
                    <div class="accordion-body rlr-accordion__body">
                      <h3 class="rlr-itinerary__title">Lake Nakuru National Park</h3>
                      <div class="rlr-readmore-desc">
                        <p class="rlr-readmore-desc__content rlr-js-desc">You can add your images, videos and itinerary route in lightbox for each itinerary as shown below, simply by changing the src path of each media.</p>
                        <span class="rlr-readmore-desc__readmore rlr-js-readmore">Show more...</span>
                      </div>
                        ...
                        <div class="rlr-itinerary__media">
                          <a data-fslightbox="demo-images" data-foo="bar" href="./assets/images/gallery/1568/suzy-brooks-nygy9pb5mp4-unsplash1568.jpg">
                            <figure class="rlr-lightbox--gallery__figure">
                              <img class="rlr-lightbox--gallery__img" src="./assets/images/gallery/thumbs/suzy-brooks-nygy9pb5mp4-unsplash507.jpg" alt="Anchor Button" />
                              <figcaption class="rlr-lightbox--gallery__figcaption">
                                <span><i class="rlr-icon-font flaticon-insert-picture-icon"> </i></span>
                              </figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="rlr-itinerary__media">
                          <a data-fslightbox="html5-demo-videos" data-video-poster="./assets/images/gallery/videos/spliderboat-sc.jpg" href="./assets/images/gallery/videos/spiderboat.mp4">
                            <figure class="rlr-lightbox--gallery__figure">
                              <img class="rlr-lightbox--gallery__img img" src="./assets/images/gallery/videos/spliderboat-sc.jpg" alt="Anchor Button" />
                              <figcaption class="rlr-lightbox--gallery__figcaption">
                                <span><i class="rlr-icon-font flaticon-play"> </i></span>
                              </figcaption>
                            </figure>
                          </a>
                        </div>
                        <div class="rlr-itinerary__media">
                          <div class="rlr-lightbox--gallery">
                            <a data-fslightbox="custom-google-maps" data-class="d-block" href="#google-maps">
                              <figure class="rlr-lightbox--gallery__figure">
                                <img class="rlr-lightbox--gallery__img" src="./assets/images/lightbox-map-thumb.jpg" alt="Itinerary Map" />
                                <figcaption class="rlr-lightbox--gallery__figcaption">
                      ...
                      <div class="rlr-itinerary__tabbed-content">
                        <nav class="rlr-nav-tabs">
                          <ul class="nav nav-tabs rlr-nav-tabs__items" id="myTab" role="tablist">
                            <li class="nav-item rlr-nav-tabs__item" role="presentation">
                              <button class="nav-link rlr-nav-tabs__link active" data-bs-toggle="tab" data-bs-target="#rlr-itinerary-accomodation" type="button" role="tab" aria-selected="true">Accommodation</button>
                            </li>
                            <li class="nav-item rlr-nav-tabs__item" role="presentation">
                              <button class="nav-link rlr-nav-tabs__link" data-bs-toggle="tab" data-bs-target="#rlr-itinerary-meals" type="button" role="tab" aria-selected="false">Meals</button>
                            </li>
                            <li class="nav-item rlr-nav-tabs__item" role="presentation">
                              <button class="nav-link rlr-nav-tabs__link" data-bs-toggle="tab" data-bs-target="#rlr-itinerary-inclusions" type="button" role="tab" aria-selected="false">Inclusions</button>
                            </li>
                            <li class="nav-item rlr-nav-tabs__item" role="presentation">
                              <button class="nav-link rlr-nav-tabs__link" data-bs-toggle="tab" data-bs-target="#rlr-itinerary-special_info" type="button" role="tab" aria-selected="false">Special Info</button>
                            </li>
                          </ul>
                        </nav>
                        <div class="tab-content rlr-tab-content" id="myTabContent">
                          <div class="tab-pane fade show active" id="rlr-itinerary-accomodation" role="tabpanel">
                            <div class="rlr-readmore-desc">
                              <p class="rlr-readmore-desc__content rlr-js-desc">Lorem Ipsum is simply dummy text of the printing and typesetting</p>
                              <span class="rlr-readmore-desc__readmore rlr-js-readmore">Show more...</span>
                            </div>
                            <div class="rlr-itinerary__room-details">
                              <div class="rlr-itinerary__room-prices">
                                <div class="rlr-itinerary__room-price">
                                  <span class="rlr-itinerary__room-type">Shared Room</span>
                                  <span>Included in packaged</span>
                                </div>
                                <div class="rlr-itinerary__room-price">
                                  <span class="rlr-itinerary__room-type">Double Room</span>
                                  <span>£45 per person extra</span>
                                </div>
                                <div class="rlr-itinerary__room-price">
                                  <span class="rlr-itinerary__room-type">Single Room</span>
                                  <span>£80 per person extra</span>
                                </div>
                              </div>
                              <div class="rlr-itinerary__media-group">
                                <div class="rlr-itinerary__media">
                                  <span class="rlr-itinerary__media-title">Single</span>
                                  <a data-fslightbox="demo-images" data-foo="bar" href="./assets/images/gallery/1568/suzy-brooks-nygy9pb5mp4-unsplash1568.jpg">
                                    <figure class="rlr-lightbox--gallery__figure">
                                      <img class="rlr-lightbox--gallery__img" src="./assets/images/misc/itinerary-1.jpg" alt="Anchor Button" />
                                      <figcaption class="rlr-lightbox--gallery__figcaption">
                                        <span>1</span>
                                      </figcaption>
                                    </figure>
                                ...
                                <div class="rlr-itinerary__media">
                                  <span class="rlr-itinerary__media-title">Double</span>
                                  <a data-fslightbox="demo-images" data-foo="bar" href="./assets/images/gallery/1568/aman-kvknav96-di-unsplash1568.jpg">
                                    <figure class="rlr-lightbox--gallery__figure">
                                      <img class="rlr-lightbox--gallery__img" src="./assets/images/misc/itinerary-2.jpg" alt="Anchor Button" />
                                      <figcaption class="rlr-lightbox--gallery__figcaption">
                                        <span>2</span>
                                      </figcaption>
                                    </figure>
                                ...
                                <div class="rlr-itinerary__media">
                                  <span class="rlr-itinerary__media-title">Shared</span>
                                  <a data-fslightbox="demo-images" data-foo="bar" href="./assets/images/gallery/1568/anna-sullivan-g7b2bqwtluq-unsplash1568.jpg">
                                    <figure class="rlr-lightbox--gallery__figure">
                                      <img class="rlr-lightbox--gallery__img" src="./assets/images/misc/itinerary-3.jpg" alt="Anchor Button" />
                                      <figcaption class="rlr-lightbox--gallery__figcaption">
                                        <span>3</span>
                                      </figcaption>
                                    </figure>
                          ...
                          <div class="tab-pane fade" id="rlr-itinerary-meals" role="tabpanel">
                            <div class="rlr-readmore-desc">
                              <p class="rlr-readmore-desc__content rlr-js-desc">
                          ...
                          <div class="tab-pane fade" id="rlr-itinerary-inclusions" role="tabpanel">
                            <div class="rlr-readmore-desc">
                              <p class="rlr-readmore-desc__content rlr-js-desc">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old.</p>
                              <span class="rlr-readmore-desc__readmore rlr-js-readmore">Show more...</span>
                            </div>
                          </div>
                          <div class="tab-pane fade" id="rlr-itinerary-special_info" role="tabpanel">
                            <div class="rlr-readmore-desc">
                              <p class="rlr-readmore-desc__content rlr-js-desc">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour</p>
                              <span class="rlr-readmore-desc__readmore rlr-js-readmore">Show more...</span>
                            </div>
                          </div>
                        </div>
                ...
                <div class="accordion-item rlr-accordion__item">
                  <div class="accordion-header rlr-accordion__header" id="rlr-itinerary-header2">
                    <button class="accordion-button rlr-accordion__button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rlr-itinerary-collapse2" aria-expanded="false" aria-controls="rlr-itinerary-collapse2">
                      <span class="rlr-accordion__badge">2</span> Day 2
                    </button>
                  </div>
                  <div id="rlr-itinerary-collapse2" class="accordion-collapse collapse" aria-labelledby="rlr-itinerary-header2">
                    <div class="accordion-body rlr-accordion__body">
                      <div class="rlr-readmore-desc">
                        <p class="rlr-readmore-desc__content rlr-js-desc">
                ...
                <div class="accordion-item rlr-accordion__item">
                  <div class="accordion-header rlr-accordion__header" id="rlr-itinerary-header3">
                    <button class="accordion-button rlr-accordion__button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rlr-itinerary-collapse3" aria-expanded="false" aria-controls="rlr-itinerary-collapse3">
                      <span class="rlr-accordion__badge">3</span> Day 3
                    </button>
                  </div>
                  <div id="rlr-itinerary-collapse3" class="accordion-collapse collapse" aria-labelledby="rlr-itinerary-header3">
                    <div class="accordion-body rlr-accordion__body">
                      <div class="rlr-readmore-desc">
                        <p class="rlr-readmore-desc__content rlr-js-desc">
                          What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#x27;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a
                ...
                <div class="accordion-item rlr-accordion__item">
                  <div class="accordion-header rlr-accordion__header" id="rlr-itinerary-header4">
                    <button class="accordion-button rlr-accordion__button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rlr-itinerary-collapse4" aria-expanded="false" aria-controls="rlr-itinerary-collapse3">
                      <span class="rlr-accordion__badge">4</span> Day 4
                    </button>
                  </div>
                  <div id="rlr-itinerary-collapse4" class="accordion-collapse collapse" aria-labelledby="rlr-itinerary-header4">
                    <div class="accordion-body rlr-accordion__body">
                      <div class="rlr-readmore-desc">
                        <p class="rlr-readmore-desc__content rlr-js-desc">
                          What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#x27;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a
                ...
                <div class="accordion-item rlr-accordion__item">
                  <div class="accordion-header rlr-accordion__header" id="rlr-itinerary-header5">
                    <button class="accordion-button rlr-accordion__button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rlr-itinerary-collapse5" aria-expanded="false" aria-controls="rlr-itinerary-collapse5">
                      <span class="rlr-accordion__badge">5</span> Day 5
                    </button>
                  </div>
                  <div id="rlr-itinerary-collapse5" class="accordion-collapse collapse" aria-labelledby="rlr-itinerary-header5">
                    <div class="accordion-body rlr-accordion__body">
                      <div class="rlr-readmore-desc">
                        <p class="rlr-readmore-desc__content rlr-js-desc">
                          What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#x27;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a
                ...
                <div class="accordion-item rlr-accordion__item">
                  <div class="accordion-header rlr-accordion__header" id="rlr-itinerary-header6">
                    <button class="accordion-button rlr-accordion__button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rlr-itinerary-collapse6" aria-expanded="false" aria-controls="rlr-itinerary-collapse6">
                      <span class="rlr-accordion__badge">6</span> Day 6
                    </button>
                  </div>
                  <div id="rlr-itinerary-collapse6" class="accordion-collapse collapse" aria-labelledby="rlr-itinerary-header6">
                    <div class="accordion-body rlr-accordion__body">
                      <div class="rlr-readmore-desc">
                        <p class="rlr-readmore-desc__content rlr-js-desc">
                          What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#x27;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a
          ...
          <div class="rlr-secondary-menu-desc" data-id="rlr-product-sec-inclusion">
            ...
            <div class="rlr-secondary-menu-desc__details">
              <div class="rlr-readmore-desc">
                <p class="rlr-readmore-desc__content rlr-js-desc">
                  Dolor elit voluptate cupidatat in eiusmod. Eiusmod ex eu incididunt etile pariatur dolor mollit reprehenderit magna tempor ex minim velit sunt do. Elit dolore sunt cupidatat minim nisi nulla fugiat sit dolor adipisicing excepteur eiusmod. Mollit reprehenderit
                  magna tempor ex.
                </p>
                <span class="rlr-readmore-desc__readmore rlr-js-readmore">Show more...</span>
              </div>
              <ul class="list-group list-group-flush rlr-secondary-menu-desc__list-group">
                <!-- Inclusions -->
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-check-rounded"> </i> <span class="rlr-icon-text__text">All breakfasts, 4 packed lunches, and 6 dinners </span></li>
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-check-rounded"> </i> <span class="rlr-icon-text__text">All Fees and Taxes </span></li>
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-check-rounded"> </i> <span class="rlr-icon-text__text">Highly experienced Government Registered guide </span></li>
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-check-rounded"> </i> <span class="rlr-icon-text__text">First aid box </span></li>
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-check-rounded"> </i> <span class="rlr-icon-text__text">All necessary documents and paperwork (TIMS cards and permit) </span></li>
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-check-rounded"> </i> <span class="rlr-icon-text__text">Farewell dinner </span></li>
                <!-- Exclusion -->
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-cross-rounded"> </i> <span class="rlr-icon-text__text">Farewell dinner </span></li>
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-cross-rounded"> </i> <span class="rlr-icon-text__text">Alcoholic Beverages </span></li>
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-cross-rounded"> </i> <span class="rlr-icon-text__text">Portugal visa fee </span></li>
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-cross-rounded"> </i> <span class="rlr-icon-text__text">Alcoholic Beverages </span></li>
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-cross-rounded"> </i> <span class="rlr-icon-text__text">Personal expenses (Phone calls, bar bills, battery recharge, laundry) </span></li>
                <li class="rlr-icon-text rlr-secondary-menu-desc__list"><i class="rlr-icon-font flaticon-cross-rounded"> </i> <span class="rlr-icon-text__text">Tipping and donations </span></li>
              </ul>
            </div>
          </div>
          <!-- Reviews -->
            ...
            <div class="rlr-secondary-menu-desc__details">
              ...
              <article class="rlr-review-card" itemscope itemtype="https://schema.org/Product">
                <div class="rlr-review-card__contact">
                  <!--Using in Components -->
                  <div class="rlr-avatar">
                    <img class="rlr-avatar__media--rounded" src="./assets/images/misc/image-2_56x56.jpg" itemprop="avatar" alt="avatar icon" />
              ...
              <article class="rlr-review-card" itemscope itemtype="https://schema.org/Product">
                <div class="rlr-review-card__contact">
                  <!--Using in Components -->
                  <div class="rlr-avatar">
                    <img class="rlr-avatar__media--rounded" src="./assets/images/misc/image-7_56x56.jpg" itemprop="avatar" alt="avatar icon" />
              ...
              <article class="rlr-review-card" itemscope itemtype="https://schema.org/Product">
                <div class="rlr-review-card__contact">
                  <!--Using in Components -->
                  <div class="rlr-avatar">
                    <img class="rlr-avatar__media--rounded" src="./assets/images/misc/image-6_56x56.jpg" itemprop="avatar" alt="avatar icon" />
              ...
              <div class="accordion rlr-accordion">
                <div class="accordion-item rlr-accordion__item">
                  <div class="accordion-header rlr-accordion__header" id="rlr-faq-collapse-header1">
                    <button class="accordion-button rlr-accordion__button" type="button" data-bs-toggle="collapse" data-bs-target="#rlr-faq-collapse1" aria-expanded="true" aria-controls="rlr-faq-collapse1">
                      <span class="rlr-accordion__badge">?</span> What type of clothing are suitable for this trek?
                    </button>
                  </div>
                ...
                <div class="accordion-item rlr-accordion__item">
                  <div class="accordion-header rlr-accordion__header" id="rlr-faq-collapse-header2">
                    <button class="accordion-button rlr-accordion__button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rlr-faq-collapse2" aria-expanded="false" aria-controls="rlr-faq-collapse2">
                      <span class="rlr-accordion__badge">?</span> What type of clothing are suitable for this trek?
                    </button>
                  </div>
                  <div id="rlr-faq-collapse2" class="accordion-collapse collapse" aria-labelledby="rlr-faq-collapse-header2">
                    <div class="accordion-body rlr-accordion__body">
                      <div class="rlr-readmore-desc">
                        <p class="rlr-readmore-desc__content rlr-js-desc">
                          What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#x27;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a
                ...
                <div class="accordion-item rlr-accordion__item">
                  <div class="accordion-header rlr-accordion__header" id="rlr-faq-collapse-header3">
                    <button class="accordion-button rlr-accordion__button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#rlr-faq-collapse3" aria-expanded="false" aria-controls="rlr-faq-collapse3">
                      <span class="rlr-accordion__badge">?</span> What type of clothing are suitable for this trek?
                    </button>
                  </div>
                  <div id="rlr-faq-collapse3" class="accordion-collapse collapse" aria-labelledby="rlr-faq-collapse-header3">
                    <div class="accordion-body rlr-accordion__body">
                      <div class="rlr-readmore-desc">
                        <p class="rlr-readmore-desc__content rlr-js-desc">
                          What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#x27;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a
          ...
          <form class="rlr-booking-card">
            <fieldset class="rlr-fieldrow">
              ...
              <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                ...
                <div class="rlr-input-group rlr-input-group__datefield rlr-js-booking-form-daterange" id="rlr-booking-startRange">
                  <input type="text" autocomplete="off" id="rlr-booking-dateranges-input" class="form-control form-input text-end" placeholder="Select preferred dates" />
                </div>
              </div>
              <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                ...
                <div class="rlr-input-group" data-bs-toggle="popover-booking" data-content-id="rlr-js-booking-travellers" id="rlr-js-booking-travellers-button">
                  <input type="button" value="1 Adult" id="rlr-booking-travellers-input" class="form-control form-input text-end rlr-popover-button" />
                  <div class="rlr-input-group__iconset--absolute">
                      ...
                      <div class="rlr-input-groups">
                        <div class="rlr-input-group rlr-input-group__numberfield rlr-custom-input--numberfield rlr-popover__numberfield">
                          ...
                          <div class="rlr-input-group__iconset rlr-js-input-group__iconset">
                            ...
                            <input type="number" autocomplete="off" id="rlr-popover-numberfield-adult" class="form-control form-input text-end rlr-booking-card__counter rlr-js-input-counter" placeholder="0" data-name="Adults" />
                        ...
                        <div class="rlr-input-group rlr-input-group__numberfield rlr-custom-input--numberfield rlr-popover__numberfield">
                          ...
                          <div class="rlr-input-group__iconset rlr-js-input-group__iconset">
                            <button type="button" tabindex="0" aria-label="decrease quantity" class="rlr-input-group__button"></button>
                            <input type="number" autocomplete="off" id="rlr-popover-numberfield-child" class="form-control form-input text-end rlr-booking-card__counter rlr-js-input-counter" placeholder="0" data-name="Child" />
                            <button type="button" tabindex="0" aria-label="increase quantity" class="rlr-input-group__button"></button>
                          </div>
                        </div>
                        <div class="rlr-input-group rlr-input-group__numberfield rlr-custom-input--numberfield rlr-popover__numberfield">
                          ...
                          <div class="rlr-input-group__iconset rlr-js-input-group__iconset">
                            <button type="button" tabindex="0" aria-label="decrease quantity" class="rlr-input-group__button"></button>
                            <input type="number" autocomplete="off" id="rlr-popover-numberfield-infant" class="form-control form-input text-end rlr-booking-card__counter rlr-js-input-counter" placeholder="0" data-name="Infant" />
                            <button type="button" tabindex="0" aria-label="increase quantity" class="rlr-input-group__button"></button>
                          </div>
                        </div>
                        <div class="rlr-input-group rlr-input-group__numberfield rlr-custom-input--numberfield rlr-popover__numberfield">
                          ...
                          <div class="rlr-input-group__iconset rlr-js-input-group__iconset">
                            <button type="button" tabindex="0" aria-label="decrease quantity" class="rlr-input-group__button"></button>
                            <input type="number" autocomplete="off" id="rlr-popover-numberfield-senior" class="form-control form-input text-end rlr-booking-card__counter rlr-js-input-counter" placeholder="0" data-name="Senior" />
                            <button type="button" tabindex="0" aria-label="increase quantity" class="rlr-input-group__button"></button>
                          </div>
                        </div>
                      </div>
              ...
              <div class="rlr-fieldrow__item rlr-booking-card__form-item">
                ...
                <div class="rlr-input-group" data-bs-toggle="popover-booking" data-content-id="rlr-js-booking-selection" id="rlr-js-booking-selection-button">
                  <input type="text" id="rlr-booking-selection-input" autocomplete="off" class="form-control form-input text-end rlr-popover-button" placeholder="Flight, hotel, car etc." />
                  <div class="rlr-input-group__iconset--absolute">
                    <span class="rlr-svg-icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 .017A11.983 11.983 0 1 0 23.984 12 11.997 11.997 0 0 0 12.002.017zm0 21.787A9.804 9.804 0 1 1 21.806 12 9.816 9.816 0 0 1 12 21.804z" fill="#99A3AD" />
        ...
        <div class="row rlr-featured__cards">
          <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-offset="250" data-aos-duration="700">
            ...
            <article class="rlr-product-card rlr-product-card--featured" itemscope itemtype="https://schema.org/Product">
              <!-- Image -->
              <figure class="rlr-product-card__image-wrapper">
                <img itemprop="image" data-src="{{URL::asset($item->image)}}" data-srcset="{{URL::asset($item->image)}}" data-sizes="auto" class="lazyload" alt="" />
              </figure>
              <!-- Card body -->
              <div class="rlr-product-card--featured__inner">
                <span class="rlr-badge rlr-badge--right rlr-badge-- rlr-badge--abs rlr-badge--abs-right"> 4.9 </span>
                <div class="rlr-product-card--featured__body card-img-overlay">
                  ...
                  <div class="rlr-product-detail-header__actions">
                    ...
                    <a href="{{ route('detalis.Trip',$item->id) }}" class="btn rlr-button product-card-buttonrlr-button--medium rlr-button--rounded rlr-button--brand"> Explore </a>
                  </div>
                </div>
              </div>
              <a href="{{ route('detalis.Trip',$item->id) }}" class="rlr-product-card__anchor rlr-product-card__anchor--featured"></a>
