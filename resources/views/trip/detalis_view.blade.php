							...
							<div class="card-body pt-0">
								<form class="form-horizontal" >
									<div class="form-group">
										<p>اسم الحدث</p>
										<input type="text" class="form-control" id="inputName" placeholder="اسم.." name="name">
									</div>

									<div class="form-group">
										<p>اسم الدوله</p>
										<input type="text" class="form-control" id="inputName" placeholder="الدوله" name="country">
									</div>

									<div class="form-group">
										<p>المدينه</p>
										<input type="text" class="form-control" id="inputName" placeholder="المدينه" name="city">
									</div>
									<div class="form-group">
										<p>عنوان الحدث كاملا</p>
										<input type="text" class="form-control" id="inputName" placeholder="عنوان..." name="ciadressty">
									</div>
								</form>
							</div>
						</div>
